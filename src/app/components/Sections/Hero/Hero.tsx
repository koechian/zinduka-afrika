      ...
      >
        <div id={"hero"} className={styles.hero}>
          ...
          <div id={"popoverCards"} className={styles.popoverContainer}>
              ...
              <div className={[styles.popoverCard, inter.className].join(" ")}>
                <div className={styles.door}>
                  ...
                  <p className={inter.className}>
                    Read more on our mission statement, our vision for the
                    future and how we strive to extend help across ethnic lines,
                    social classes, academics and physical boundaries to those
                    in need.
                  </p>
                </div>
                <p>
                  From humble hearts to towering peaks, In every soul, the fire
                  speaks, Unite as one, let hope unfurl, Arise! Change the
                  world. Beyond the doubts that hold us down, With courage
                  strong, our spirits crown, A destiny we can't but swirl,
                  Arise! Change the world. Through struggles faced, we'll
                  persevere, With empathy, we'll dry each tear, In unity, our
                  strength is curled, Arise! Change the world.
                </p>
            ...
            <a
              href={"/Zinduka Education Programme.pdf"}
              download={"Education Programme.pdf"}
            >
              <div className={[styles.popoverCard, inter.className].join(" ")}>
                <div className={[styles.door, inter.className].join(" ")}>
                  <h3 className={inter.className}>
                    {" "}
                    Zinduka Afrika Education Programme
                  </h3>
                  <br />
                  <p className={inter.className}>
                    See how the Zinduka Afrika Education Programme is impacting
                    the education sector through outreaches to schools,
                    mentorship programmes, sanitary pads donations and
                    scholarships.
                  </p>
                </div>
                <p>
        ...
        <div className={styles.cardsContainer}>
                ...
                <div className={styles.cardContentWrapper}>
                  <div className={styles.cardMedBody}>
                    ...
                    <p style={{ fontSize: "1.1em" }}>
                      of girls in Kenya are unable to afford sanitary towels on
                      a monthly basis
                    </p>
                  </div>
                  ...
                  <a
                    target={"_blank"}
                    href="https://amref.org/position-statements/amref-health-africa-statement-on-addressing-period-poverty-and-stigma-in-kenya/#:~:text=The%20fact%20that%2065%25%20of,and%20preventing%20infection%20during%20menstruation."
                  >
                    <div
              ...
              >
                <div className={styles.overlay}>
                  ...
                  <span className={inter.className}>
                    Providing sanitary pads to girls in Secondary Schools
                    through patnerships
                  </span>
                </div>
              </div>
                  ...
                  <a href="https://iccnairobi.org/">
                    ...
                    >
                      <p style={{ color: "#222222", fontSize: "1.4em" }}>
                        Explore our mother organization to learn more
                      </p>
                      {/* Custom Link Component */}
                      <CustomLink />
                    </div>
            ...
            <div className={styles.cardsCol}>
              ...
              >
                <div className={styles.cardContentWrapper}>
                  ...
                  <a
                    target={"_blank"}
                    href="https://www.facebook.com/people/Zinduka-Afrika/100067437003426/?paipv=0&eav=AfaungGYcbM5YgLSNDbFCPm9r6xm80t0MXuPGbv8wTCjnM7zSCLVEEbVTkSFCS023WU&_rdr"
                  >
                    <div
                      className={[styles.cardMedFooter, "cardMedFooter"].join(
                        " "
          ...
          <div className={styles.mobileColoumn}>
            ...
            >
              <div className={styles.overlay}>
                ...
                <span className={inter.className} style={{ color: "#9A9A9A" }}>
                  65% of girls in Kenya are unable to afford sanitary towels on
                  a monthly basis, we aim to reduce that percentage
                </span>
              </div>
            </div>
            <div
            ...
            >
              <div className={styles.overlay}>
                <span>
                  Impacting young lives through donations and ministry
                </span>
                <span className={inter.className} style={{ color: "#9A9A9A" }}>
            ...
            >
              <div className={styles.overlay}>
                ...
                <span className={inter.className} style={{ color: "#9A9A9A" }}>
                  If you give a man a fish, you feed him for a day. If you teach
