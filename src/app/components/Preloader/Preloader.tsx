...
const Preloader = () => {
    ...
    useEffect(()=>{
        ...
        timeline.from(clipBottom.current,{delay :1,height:"50vh",ease:"power1.inOut"})
            .from(clipTop.current,{delay :1,height:"50vh",ease:"power1.inOut"},0)
            // animate text in
            .to(marquee1.current,{delay :0.75,top:"50%",ease:"power4.inOut",duration:1},0)
            .to(marquee1.current,{delay:1,left:"100%",duration:1},0)
            .to(marquee2.current,{delay :0.75,top:"50%",ease:"power4.inOut",duration:1},0)
            .to(marquee2.current,{delay:1,left:"100%",duration:1},0)
            .to(marquee3.current,{delay :0.75,top:"50%",ease:"power4.inOut",duration:1},0)
            .from(marquee3.current,{opacity:1,duration:1},0)
            // animate top and bottom out
            .to(clipTop.current,{delay:1, clipPath:"inset(0 0 100% 0",ease:"power4.inOut",duration:1.5},1)
            .to(clipBottom.current,{delay:1, clipPath:"inset(100% 0 0 0)",ease:"power4.inOut",duration:1.5},1)
            .to(clipBottom.current,{delay:1, clipPath:"inset(100% 0 0 0)",ease:"power4.inOut",duration:1.5},1)
            .to(clipCenter.current, {duration: 1,opacity: 0,y:"-10%"})
            .to(loader.current,{opacity:0,duration:1, onComplete:()=>{
    ...
    return (
        <div ref={loader} className={styles.loader}>
            <div ref={clipTop} className={[styles.loaderClip, styles.clipTop].join(" ")}>
            ...
            <div ref={clipBottom} className={[styles.loaderClip, styles.clipBottom].join(" ")}>
